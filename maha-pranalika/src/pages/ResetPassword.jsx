...
.catch(err => {
  ...
  window.alert(err.response?.data?.message || "Token verification failed");
});
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("http://localhost:5000/api/auth/resetpassword",{email,newPassword:password,confirmNewPassword:confirmPassword}).then(res=>{
